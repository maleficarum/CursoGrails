...
<%@ page import="mx.angellore.grails.domain.Category" %>
<!doctype html>
<html>
	<head>
			...
			<table>
				...
				<g:each in="${categoryInstanceList}" status="i" var="categoryInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${categoryInstance.id}">${fieldValue(bean: categoryInstance, field: "dateCreated")}</g:link></td>
