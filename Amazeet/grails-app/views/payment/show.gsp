	...
	<body>
		...
		<div id="show-payment" class="content scaffold-show" role="main">
			...
			<ol class="property-list payment">
				...
				<g:if test="${paymentInstance?.commission}">
				<li class="fieldcontain">
					<span id="commission-label" class="property-label"><g:message code="payment.commission.label" default="Commission" /></span>
					
						<span class="property-value" aria-labelledby="commission-label"><g:fieldValue bean="${paymentInstance}" field="commission"/></span>
